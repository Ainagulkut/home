const charactersInfo = {
    ...
    "results": [
...

        {
            ...
            {
                "name":
                    "Citadel of Ricks", "url": "https://rickandmortyapi.com/api/location/3"
            },
            "image":
...
charactersInfo.results.forEach(character => {
